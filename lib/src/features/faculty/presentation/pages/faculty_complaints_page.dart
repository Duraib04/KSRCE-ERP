...
class FacultyComplaintsPage extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('View and respond to student complaints and grievances', style: TextStyle(color: AppColors.textLight, fontSize: 14)),
            ...
            Container(
              ...
              child: DataTable(
                ...
                columnSpacing: 16,
                columns: const [
                  DataColumn(label: Text('ID', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 13))),
                  DataColumn(label: Text('Student', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 13))),
                  DataColumn(label: Text('Subject', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 13))),
                  DataColumn(label: Text('Category', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 13))),
                  DataColumn(label: Text('Date', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 13))),
                  DataColumn(label: Text('Priority', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.bold, fontSize: 13))),
                  ...
                  Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 4),
                        Text('Filed: 22 Feb 2026 | Priority: High | Category: Academic', style: TextStyle(color: AppColors.textLight, fontSize: 12)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 16),
                  const Text('Response', style: TextStyle(color: AppColors.textMedium, fontSize: 13)),
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Update Status', style: TextStyle(color: AppColors.textMedium, fontSize: 13)),
                            const SizedBox(height: 6),
                            Container(
  ...
  DataRow _complaintRow(String id, String student, String subject, String category, String date, String priority, String status, Color statusColor) {
    ...
    return DataRow(cells: [
      DataCell(Text(id, style: const TextStyle(color: AppColors.textMedium, fontSize: 12))),
      DataCell(Text(student, style: const TextStyle(color: AppColors.textDark, fontSize: 12))),
      DataCell(SizedBox(width: 200, child: Text(subject, style: const TextStyle(color: AppColors.textMedium, fontSize: 12), overflow: TextOverflow.ellipsis))),
      DataCell(Text(category, style: const TextStyle(color: AppColors.textLight, fontSize: 12))),
      DataCell(Text(date, style: const TextStyle(color: AppColors.textLight, fontSize: 12))),
      DataCell(Container(
      ...
      DataCell(IconButton(icon: const Icon(Icons.reply, color: AppColors.textLight, size: 18), onPressed: () {}, tooltip: 'Respond')),
    ]);
  }
}
