...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  int _selectedRole = 0; // 0=Student, 1=Faculty, 2=Admin
  ...
  final List<String> _placeholders = ['Eg. S20210001', 'Eg. FAC001', 'Eg. ADM001'];
  final Map<String, Map<String, String>> _demoCredentials = {
    'Student': {'userId': 'S20210001', 'password': 'demo123'},
    'Faculty': {'userId': 'FAC001', 'password': 'demo123'},
  ...
  void _login() async {
    ...
    final role = _roles[_selectedRole].toLowerCase();
    final demo = _demoCredentials[_roles[_selectedRole]]!;
    if (userId == demo['userId'] && password == demo['password']) {
      if (mounted) {
        if (role == 'student') {
            ...
            child: SingleChildScrollView(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFF1E3055), width: 1),
                  boxShadow: [
                    BoxShadow(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: ClipOval(
                            child: Image.network(
                              ...
                              errorBuilder: (c, e, s) => Container(
                                ...
                                child: const Icon(Icons.school, size: 40, color: Color(0xFFD4A843)),
                              ),
                            ),
                          ),
                        ),
                        ...
                        Text(
                          'Access your college ERP portal',
                        ...
                        Align(
                          ...
                          child: Text('User ID', style: TextStyle(color: Colors.white.withOpacity(0.8), fontSize: 14, fontWeight: FontWeight.w500)),
                        ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: _placeholders[_selectedRole],
                            ...
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12),
                              borderSide: BorderSide(color: const Color(0xFF1E3055)),
                            ),
                            enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(12),
                              borderSide: const BorderSide(color: Color(0xFF1E3055)),
                            ),
                        ...
                        Align(
                          alignment: Alignment.centerLeft,
                          child: Text('Password', style: TextStyle(color: Colors.white.withOpacity(0.8), fontSize: 14, fontWeight: FontWeight.w500)),
                        ),
                        const SizedBox(height: 8),
                        TextFormField(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              onPressed: () {},
                              child: const Text('Forgot Password?', style: TextStyle(color: Color(0xFF42A5F5), fontSize: 13)),
                            ),
                          ],
                        ),
                        const SizedBox(height: 20),
                            ...
                            children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 8),
                                      Text(
                                        'Demo Credentials (${_roles[_selectedRole]})',
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    _demoCredentials[_roles[_selectedRole]]!['userId']!,
                                    style: const TextStyle(color: Color(0xFFD4A843), fontSize: 12, fontFamily: 'monospace'),
                                  ),
                                  const SizedBox(width: 20),
                                  Text('Pass: ', style: TextStyle(color: Colors.white.withOpacity(0.4), fontSize: 12)),
                                  Text(
                                    _demoCredentials[_roles[_selectedRole]]!['password']!,
                                    style: const TextStyle(color: Color(0xFFD4A843), fontSize: 12, fontFamily: 'monospace'),
                                  ),
                                ],
                              ),
