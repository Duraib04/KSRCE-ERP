...
class _StudentResultsPageState extends State<StudentResultsPage> {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildResultsTable(subjects, isMobile),
                const SizedBox(height: 16),
                _buildSGPA(semData['sgpa'] as double, isMobile),
              ],
            ),
          );
        },
  ...
  Widget _buildGPASummary(bool isMobile) {
    final children = [
  ...
  Widget _buildResultsTable(List<Map<String, dynamic>> subjects, bool isMobile) {
  ...
  Widget _buildSGPA(double sgpa, bool isMobile) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
